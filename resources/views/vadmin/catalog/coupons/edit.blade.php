...
@section('title', 'VADmin | Editar cupón')

@section('header')
	@component('vadmin.components.header')
		@slot('breadcrums')
			<li class="breadcrumb-item"><a href="{{ url('vadmin')}}">Inicio</a></li>
			<li class="breadcrumb-item"><a href="{{ route('coupons.index')}}">Listado de cupones</a></li>
			<li class="breadcrumb-item active">Edición de cupón</li>
		@endslot
		@slot('actions')
			<div class="list-actions">
				<h2>Editando cupón</h2>
				{{-- Edit --}}
